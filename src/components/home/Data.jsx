...
function Data() {
  return (
    <div className='home_data'>
        ...
        <p className="home_description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut tenetur facilis aliquid soluta reprehenderit aliquam alias eius ratione tempora eaque commodi iste incidunt iusto nesciunt deleniti deserunt, fuga maxime officiis.</p>
